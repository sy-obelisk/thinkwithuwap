...
<head>
    <?php
    $seo = \app\modules\cn\models\Category::getSeoInfo(164);
    ?>
...
<!-----------------------------导航end------------------------------>
<div class="courseTop">
    <img src="/cn/images/course-fontImg03.png" alt="头部图"/>
</div>

<div class="queryContent">
    <ul>
        <?php
            $data  = \app\modules\cn\models\Content::getContent(['category' => '164','pageSize' => 6]);
        foreach($data as $v) {
            ?>
            <li>
                <a href="/picture-details/<?php echo $v['id']?>/164.html">
                <h4 class="mtspe"><?php echo $v['name']?></h4>
                <b></b>
                </a>
            </li>
        <?php
