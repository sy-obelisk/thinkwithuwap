<link rel="stylesheet" href="/cn/css/admissionSchool.css"/>
...
<div class="quesAcontent">
    <div class="contentLeft">
        ...
        <div class="frameNav">
            ...
            ?>
            <a href="#"><?php echo $data[0]['name']?></a>
        </div>
        <div class="schoolContent">
            <div class="schoolTitle">
                <h3><?php echo $data[0]['name']?></h3>
                <span>浏览次数：<?php echo  $data[0]['viewCount']+1 ?> 日期：<?php echo  $data[0]['createTime'] ?></span>
            </div>
            <div class="schoolImgInfo">
            ...
            <div class="PreviousNext">
                <?php if(count($next)>0) { ?>
                    <a href="/word-details/<?php echo $next[0]['id']?>/<?php echo $changeNeedCategory?>.html">下一篇：<?php echo $next[0]['name']?></a>
                <?php
                }
                ?>
                <?php if(count($prev)>0) { ?>
                    <a href="/word-details/<?php echo $prev[0]['id']?>/<?php echo $changeNeedCategory?>.html">上一篇：<?php echo $prev[0]['name']?></a>
                <?php
                }
                ?>
            </div>
