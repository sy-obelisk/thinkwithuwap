    ...
    <div class="contentLeft">
                ...
                <?php
                    foreach($contentData as $v) {
                        ...
                        <li>
                            ...
                            <a href="/word-details/<?php echo $v['id']?>/206.html">祝贺<?php echo $v['name']?></a>
        ...
        <script type="text/javascript">
            function goPage(){
                ...
                var page = $('.pageNumber').val();
                location.href="/cn/case/high-score?page="+page;
            }
        </script>
        <div class="page pagetop">
            <ul>
                <li>总数：<?php echo $count?></li>
                <li><a href="<?php echo "/cn/case/high-score?page=1"?>">首页</a></li>
                <li><a href="<?php echo ($page >1)?'/cn/case/high-score?page='.($page-1):'javascript:;'?>">上一页</a></li>
                <li><a href="<?php echo ($page <$total)?'/cn/case/high-score?page='.($page+1):'javascript:;'?>">下一页</a></li>
                <li class="mr"><a href="<?php echo "/cn/case/high-score?page=$total"?>">尾页</a></li>
