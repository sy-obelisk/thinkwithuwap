...
<div class="graduateNav">
    <div class="graN-left leftDiffb02">
        <div>博士留学</div>
    </div>
    <div class="graN-right rightDiff02">
        <ul>
            <li><a href="#USA">美国博士留学</a></li>
            <li><a href="#UK">英国博士留学</a></li>
            <li><a href="#HK">香港博士留学</a></li>
            <li><a href="#TA">澳洲博士留学</a></li>
            <li><a href="#other">其他博士留学</a></li>
        </ul>
    </div>
</div>
<div class="graduateBan gradu02">
    <div class="advantage">
        <div class="advanLeft">
            <div class="leftBanner01">
                <div class="bannerLhd hd">
                    <ul>
                        <?php
                        $data = \app\modules\cn\models\Content::getContent(['category' => '137,178,190','pageSize' => 3]);
                        foreach($data as $v) {
                            ?>
                            <li></li>
                        <?php
            ...
            <div class="dissertation newMT02">
                ...
                <div class="details">
                    <div class="det-left">
                        <a href="/word-details/243/105,118.html">
        ...
        <div class="advanCenter newMT">
            <div class="centerBanner">
                ...
                <div class="adCbd">
                    <ul>
                        <?php
                        $data = \app\modules\cn\models\Content::getContent(['category' => '137,118','pageSize' => 5]);
                        foreach($data as $k=>$v) {
                            ?>
                            <li><a href="/word-details/<?php echo $v['id']?>/137,118.html"><?php echo $v['name']?></a></li>
                        <?php
                        }
                        ?>
                    </ul>
                    <ul>
                        <?php
                        $data = \app\modules\cn\models\Content::getContent(['category' => '137,175','pageSize' => 5]);
                        foreach($data as $k=>$v) {
                            ?>
                            <li><a href="/word-details/<?php echo $v['id']?>/137,175.html"><?php echo $v['name']?></a></li>
                        <?php
                        }
                        ?>
                    </ul>
                    <ul>
                        <?php
                        $data = \app\modules\cn\models\Content::getContent(['category' => '137,143','pageSize' => 5]);
                        foreach($data as $k=>$v) {
                            ?>
                            <li><a href="/word-details/<?php echo $v['id']?>/137,143.html"><?php echo $v['name']?></a></li>
                        <?php
                        }
                        ?>
                    </ul>
            ...
            <div class="bannerRight">
                ...
                <div class="bannerRbd bd">
                    <ul>
                        <li>
                            <div class="labaTiao">
                                <img src="/cn/images/graduate_bannerLaBa02.png" alt="小喇叭图标"/>
                                <b>新鲜出炉：</b>
                    ...
                    <ul>
                        <li>
                            ...
                            <img src="/cn/images/index_topScore.jpg" alt="高分榜单" width="100%" height="59"/>
                        </li>
                    </ul>
                </div>
            </div>
...
<div id="USA" class="essence speColor02">
    <ul>
<?php
    $data = \app\modules\cn\models\Content::getContent(['category' => '114','pageSize' => 4]);
    foreach($data as $v) {
        ?>
        <li>
            <div>
                <a href="/word-details/<?php echo $v['id']?>/114.html">
                    <img src="<?php echo $v['image']?>" alt="人人图标"/>
                    <b><?php echo $v['name']?></b>
                </a>
            </div>
            <h4> <a href="/word-details/<?php echo $v['id']?>/114.html"><?php echo $v['title']?> </a></h4>
        </li>
    <?php
    }
        ?>
        ...
        <li>
            <div>
                <a href="/Doctor/assistance.html">
                <img src="/cn/images/graduate_person06.png" alt="人人图标"/>
               <b>博士申请方案</b>
                </a>
            </div>
            <h4><a href="/Doctor/assistance.html">博士申请方案 </a></h4>
        </li>
    </ul>
</div>
<div id="USA" class="graduateComT02">
    <h1>博士留学 ● 美国</h1>
</div>
<div id="UK" class="doctorSort">
    <div class="doctorS-left"><img src="/cn/images/doctor_peron.png" alt="人人图标"/></div>
    <div class="doctorS-right">
        <ul>
            <li>
                ...
                <ul>
                    <?php
                    $data = \app\modules\cn\models\Content::getContent(['category' => '225,88,137','pageSize' => 5]);
                    foreach($data as $k=>$v) {
                        ?>
            ...
            <li>
                ...
                <ul>
                    <?php
                    $data = \app\modules\cn\models\Content::getContent(['category' => '127,88,137','pageSize' => 5]);
                    foreach($data as $k=>$v) {
                        ?>
            ...
            <li>
                ...
                <ul>
                    <?php
                    $data = \app\modules\cn\models\Content::getContent(['category' => '128,88,137','pageSize' => 5]);
                    foreach($data as $k=>$v) {
                        ?>
            ...
            <li>
                ...
                <ul>
                    <?php
                    $data = \app\modules\cn\models\Content::getContent(['category' => '129,88,137','pageSize' => 5]);
                    foreach($data as $k=>$v) {
                        ?>
...
<div id="UK" class="graduateComT02">
    <h1>博士留学 ● 英国</h1>
</div>
<div class="fourSort divBack02">
    <ul>
        <li>
            ...
            <div>
                ...
                <ul>
                    <?php
                    $data = \app\modules\cn\models\Content::getContent(['category' => '225,89,137','pageSize' => 5]);
                    foreach($data as $k=>$v) {
                        ?>
                        <li><a href="/word-details/<?php echo $v['id']?>/225.html"><?php echo $v['name']?></a></li>
                    <?php
        ...
        <li>
            ...
            <div>
                ...
                <ul>
                    <?php
                    $data = \app\modules\cn\models\Content::getContent(['category' => '127,89,137','pageSize' => 5]);
                    foreach($data as $k=>$v) {
                        ?>
        ...
        <li>
            ...
            <div>
                ...
                <ul>
                    <?php
                    $data = \app\modules\cn\models\Content::getContent(['category' => '128,89,137','pageSize' => 5]);
                    foreach($data as $k=>$v) {
                        ?>
        ...
        <li>
            ...
            <div>
                ...
                <ul>
                    <?php
                    $data = \app\modules\cn\models\Content::getContent(['category' => '129,89,137','pageSize' => 5]);
                    foreach($data as $k=>$v) {
                        ?>
...
<div id="HK" class="graduateComT02">
    <h1>博士留学 ● 香港</h1>
</div>
<div id="TA" class="doctorOthSort">
    <ul>
        <li>
            <div class="diffBack01"><span>院校</span><b></b></div>
            <ul>
                <?php
                $data = \app\modules\cn\models\Content::getContent(['category' => '225,90,137','pageSize' => 5]);
                foreach($data as $k=>$v) {
                    ?>
                    <li><a href="/word-details/<?php echo $v['id']?>/225.html"><?php echo $v['name']?></a></li>
                <?php
        ...
        <li>
            <div class="diffBack02"><span>文书</span><b></b></div>
            <ul>
                <?php
                $data = \app\modules\cn\models\Content::getContent(['category' => '127,90,137','pageSize' => 5]);
                foreach($data as $k=>$v) {
                    ?>
                    <li><a href="/word-details/<?php echo $v['id']?>/89,127.html"><?php echo $v['name']?></a></li>
                <?php
        ...
        <li>
            <div class="diffBack03"><span>面试</span><b></b></div>
            <ul>
                <?php
                $data = \app\modules\cn\models\Content::getContent(['category' => '128,90,137','pageSize' => 5]);
                foreach($data as $k=>$v) {
                    ?>
                    <li><a href="/word-details/<?php echo $v['id']?>/89,128.html"><?php echo $v['name']?></a></li>
                <?php
        ...
        <li>
            <div class="diffBack04"><span>签证</span><b></b></div>
            <ul>
                <?php
                $data = \app\modules\cn\models\Content::getContent(['category' => '129,90,137','pageSize' => 5]);
                foreach($data as $k=>$v) {
                    ?>
                    <li><a href="/word-details/<?php echo $v['id']?>/89,129.html"><?php echo $v['name']?></a></li>
                <?php
...
<div id="TA" class="graduateComT02">
    <h1>博士留学 ● 澳洲</h1>
</div>
<div class="otherSort">
    <ul>
        <li>
            ...
            <ul>
                <?php
                $data = \app\modules\cn\models\Content::getContent(['category' => '225,91,137','pageSize' => 5]);
                foreach($data as $k=>$v) {
                    ?>
                    <li><a href="/word-details/<?php echo $v['id']?>/225.html"><?php echo $v['name']?></a></li>
                <?php
        ...
        <li>
            ...
            <ul>
                <?php
                $data = \app\modules\cn\models\Content::getContent(['category' => '127,91,137','pageSize' => 5]);
                foreach($data as $k=>$v) {
                    ?>
                    <li><a href="/word-details/<?php echo $v['id']?>/89,127.html"><?php echo $v['name']?></a></li>
                <?php
        ...
        <li>
            ...
            <ul>
                <?php
                $data = \app\modules\cn\models\Content::getContent(['category' => '159,91,137','pageSize' => 5]);
                foreach($data as $k=>$v) {
                    ?>
                    <li><a href="/word-details/<?php echo $v['id']?>/89,128.html"><?php echo $v['name']?></a></li>
                <?php
        ...
        <li>
            ...
            <ul>
                <?php
                $data = \app\modules\cn\models\Content::getContent(['category' => '129,91,137','pageSize' => 5]);
                foreach($data as $k=>$v) {
                    ?>
                    <li><a href="/word-details/<?php echo $v['id']?>/89,129.html"><?php echo $v['name']?></a></li>
                <?php
...
<div id="other" class="graduateComT02">
    <h1>博士留学 ● 其他国家</h1>
</div>
<div class="otherCityShow oneStyle">
    <ul>
        <li>
            <b></b>
            <div class="circle">
            ...
            <div class="haveUL">
                <ul>
                    <?php
                    $data = \app\modules\cn\models\Content::getContent(['category' => "137,93","pageSize" => 5]);
                    foreach($data as $v) {
                        ?>
        ...
        <li>
            ...
            <div class="haveUL">
                <ul>
                    <?php
                    $data = \app\modules\cn\models\Content::getContent(['category' => "137,94","pageSize" => 5]);
                    foreach($data as $v) {
                        ?>
        ...
        <li>
            ...
            <div class="haveUL">
                <ul>
                    <?php
                    $data = \app\modules\cn\models\Content::getContent(['category' => "137,95","pageSize" => 5]);
                    foreach($data as $v) {
                        ?>
        ...
        <li>
            ...
            <div class="haveUL">
                <ul>
                    <?php
                    $data = \app\modules\cn\models\Content::getContent(['category' => "137,96","pageSize" => 5]);
                    foreach($data as $v) {
                        ?>
        ...
        <li>
            ...
            <div class="haveUL">
                <ul>
                    <?php
                    $data = \app\modules\cn\models\Content::getContent(['category' => "137,97","pageSize" => 5]);
                    foreach($data as $v) {
                        ?>
