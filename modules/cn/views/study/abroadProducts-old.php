...
<head>
    <?php
    $seo = \app\modules\cn\models\Category::getSeoInfo(109);
    ?>
...
<div class="abroadProBig">
    <div class="abroadPro-top">
        <img src="/cn/images/abroadPro_topImg.png" alt="图标"/>
    </div>
    <div class="abroadPro-group">
        <ul>
            <li>
                <div class="inputBG blueFont inputBG01">
            ...
            <li>
                <div class="inputBG blueFont inputBG02">
                    <a href="#">申友留学服务四大优势</a>
                    <div>
                        <span></span>
    ...
    <div class="abroadPro-apply">
        <ul>
            <li>
                <a href="/Postgraduate/assistance.html"><div class="applyFA01"><div></div><span>硕士申请方案</span></div></a>
            </li>
            <li>
                <a href="/Undergraduate/assistance.html"><div class="applyFA02"><div></div><span>本科申请方案</span></div></a>
            </li>
            <li>
                <a href="/Doctor/assistance.html"><div class="applyFA03"><div></div><span>博士申请方案</span></div></a>
            </li>
            <li>
                <a href="#"><div class="applyFA04"><div></div><span>申友留学服务优势</span></div></a>
            </li>
            <li>
                <a href="/individual"><div class="applyFA05"><div></div><span>单项服务加油站</span></div></a>
            </li>
            <li>
                <a href="/MBA-PHD.html"><div class="applyFA06"><div></div><span>MBA/PHD</span></div></a>
            </li>
        </ul>
    </div>
    <div class="abroadPro-advan advanBG02">
            ...
            <div class="ul01Bd">
                <ul>
                    <li>
                        <ul>
                            <?php
                            $data = \app\modules\cn\models\Content::getContent(['fields' => 'abroadSchool,major','category' => "104,207",'page' => 1,'pageSize' =>7]);
                            foreach($data as $v) {
                                ?>
                                <li>
                    ...
                    <li>
                        <ul>
                            <?php
                            $data = \app\modules\cn\models\Content::getContent(['fields' => 'abroadSchool,major','category' => "104,207",'page' => 2,'pageSize' =>7]);
                            foreach($data as $v) {
                                ?>
                                <li>
                                    <span class="aboBot-span01"><?php echo $v['name']?></span>
                    ...
                    <li>
                        <ul>
                            <?php
                            $data = \app\modules\cn\models\Content::getContent(['fields' => 'abroadSchool,major','category' => "104,207",'page' => 3,'pageSize' =>7]);
                            foreach($data as $v) {
                                ?>
                                <li>
                                    <span class="aboBot-span01"><?php echo $v['name']?></span>
                    ...
                    <li>
                        <ul>
                            <?php
                            $data = \app\modules\cn\models\Content::getContent(['fields' => 'abroadSchool,major','category' => "104,207",'page' => 4,'pageSize' =>7]);
                            foreach($data as $v) {
                                ?>
                                <li>
                                    <span class="aboBot-span01"><?php echo $v['name']?></span>
...
<!--    <div class="abroadPro-admiss">-->
<!--        <div class="aboTitle"><h1>名校录取榜</h1></div>-->
<!--        <div class="aboBot-ul scorll01">-->
<!--            <div class="ul01">-->
<!--                <ul>-->
<!--                    --><?php
//                        $data = \app\modules\cn\models\Content::getContent(['fields' => 'abroadSchool,major','category' => '104,207','page' => 1,'pageSize' =>8]);
//                        foreach($data as $v) {
//                            ?>
<!--                            <li>-->
<!--                                <span class="aboBot-span01">--><?php //echo $v['name']?><!--</span>-->
...
<!--        </div>-->
<!--        <script type="text/javascript">-->
<!--            jQuery(".scorll01").slide({mainCell:".ul01 ul",autoPlay:true,effect:"topMarquee",interTime:50,vis:7});-->
<!--        </script>-->
<!--        <div class="aboBot-ul scorll02">-->
<!--            <div class="ul01">-->
<!--                <ul>-->
<!--                    <li>-->
<!--                        <span class="aboBot-span01">F同学</span>-->
<!--                        <span class="aboBot-span02">约克大学</span>-->
<!--                        <span class="aboBot-span03">会计</span>-->
<!--                    </li>-->
<!--                    <li>-->
<!--                        <span class="aboBot-span01">W同学</span>-->
<!--                        <span class="aboBot-span02">哥伦比亚大学</span>-->
<!--                        <span class="aboBot-span03">会计</span>-->
<!--                    </li>-->
<!--                    <li>-->
<!--                        <span class="aboBot-span01">F同学</span>-->
...
<!--        </div>-->
<!--        <script type="text/javascript">-->
<!--            jQuery(".scorll02").slide({mainCell:".ul01 ul",autoPlay:true,effect:"topMarquee",interTime:50,vis:7});-->
<!--        </script>-->
<!--        <div class="aboBot-ul scorll03">-->
<!--            <div class="ul01">-->
<!--                <ul>-->
<!--                    --><?php
//                    $data = \app\modules\cn\models\Content::getContent(['fields' => 'abroadSchool,major','category' => '104,207','page' => 2,'pageSize' =>8]);
//                    foreach($data as $v) {
//                    ?>
<!--                    <li>-->
<!--                        <span class="aboBot-span01">--><?php //echo $v['name']?><!--</span>-->
...
<!--        </div>-->
<!--        <script type="text/javascript">-->
<!--            jQuery(".scorll03").slide({mainCell:".ul01 ul",autoPlay:true,effect:"topMarquee",interTime:50,vis:7});-->
<!--        </script>-->
<!--    </div>-->
    <div class="abroadPro-school">
        <div class="schoolBd">
            <ul>
                <?php
                $data = \app\modules\cn\models\Content::getContent(['fields' => 'abroadSchool,major','category' => '104,207']);
                    foreach($data as $v) {
                        ?>
