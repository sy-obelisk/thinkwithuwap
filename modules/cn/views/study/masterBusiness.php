...
<div class="graduateNav">
    <div class="graN-left leftDiffb03">
        <div>硕士留学</div>
    </div>
    <div class="graN-right rightDiff03">
        <ul>
            <li><a href="#USA">美国硕士留学</a></li>
            <li><a href="#UK">英国硕士留学</a></li>
            <li><a href="#HK">香港硕士留学</a></li>
            <li><a href="#TA">澳洲硕士留学</a></li>
            <li><a href="#other">其他硕士留学</a></li>
        </ul>
    </div>
</div>
<div class="graduateBan gradu03">
    <div class="advantage">
        <div class="advanLeft">
            <div class="leftBanner01">
                <div class="bannerLhd hd">
                    <ul>
                        <?php
                        $data = \app\modules\cn\models\Content::getContent(['category' => '136,178,190','pageSize' => 3]);
                        foreach($data as $v) {
                            ?>
                            <li></li>
                        <?php
        ...
        <div class="advanCenter newMT">
            <div class="centerBanner">
                ...
                <div class="adCbd">
                    <ul>
                        <?php
                        $data = \app\modules\cn\models\Content::getContent(['category' => '136,118','pageSize' => 5]);
                        foreach($data as $k=>$v) {
                            ?>
                            <li><a href="/word-details/<?php echo $v['id']?>/136,118.html"><?php echo $v['name']?></a></li>
                        <?php
                        }
                        ?>
                    </ul>
                    <ul>
                        <?php
                        $data = \app\modules\cn\models\Content::getContent(['category' => '136,175','pageSize' => 5]);
                        foreach($data as $k=>$v) {
                            ?>
                            <li><a href="/word-details/<?php echo $v['id']?>/136,175.html"><?php echo $v['name']?></a></li>
                        <?php
                        }
                        ?>
                    </ul>
                    <ul>
                        <?php
                        $data = \app\modules\cn\models\Content::getContent(['category' => '136,143','pageSize' => 5]);
                        foreach($data as $k=>$v) {
                            ?>
                            <li><a href="/word-details/<?php echo $v['id']?>/136,143.html"><?php echo $v['name']?></a></li>
                        <?php
                        }
                        ?>
                    </ul>
        ...
        <div class="advanRight">
            <div class="bannerRight">
                ...
                <div class="bannerRbd bd">
                    <ul>
                        <li>
                            <div class="labaTiao">
                                <img src="/cn/images/graduate_bannerLaBa03.png" alt="小喇叭图标"/>
                                <b>新鲜出炉：</b>
            ...
            <div style="clear: both"></div>
            <div class="assessBtn">
                <a href="/evaluation.html" class="diffBac03">
...
<div id="USA" class="essence speColor03">
    <ul>
        <?php
        ...
        foreach($data as $v) {
            ...
            <li>
                <div>
                    <a href="/word-details/<?php echo $v['id']?>/113.html">
                    <img src="<?php echo $v['image']?>" alt="人人图标"/>
                    <b><?php echo $v['name']?></b>
                    </a>
                </div>
                <h4><a href="/word-details/<?php echo $v['id']?>/113.html"><?php echo $v['title']?> </a></h4>
            </li>
        <?php
        }
        ?>
        ...
        <li>
            <div>
                <a href="/Postgraduate/assistance.html">
                    <img src="/cn/images/graduate_person06.png" alt="人人图标"/>
                    <b>硕士申请方案</b>
                </a>
            </div>
            <h4><a href="/Postgraduate/assistance.html">硕士申请方案 </a></h4>
        </li>
    </ul>
</div>
<div id="USA" class="graduateComT03">
    <h1>硕士留学 ● 美国</h1>
</div>
<div id="UK" class="masterOfC">
    <ul>
        <li>
            <b></b>
            <div><img src="/cn/images/masterOf_img01.png" alt="图片"/></div>
            <h4>院校</h4>
            <ul>
                <?php
                $data = \app\modules\cn\models\Content::getContent(['category' => '225,88,136','pageSize' => 5]);
                foreach($data as $k=>$v) {
                    ?>
        ...
        <li>
            <b></b>
            <div><img src="/cn/images/masterOf_img02.png" alt="图片"/></div>
            <h4>文书</h4>
            <ul>
                <?php
                $data = \app\modules\cn\models\Content::getContent(['category' => '127,88,136','pageSize' => 5]);
                foreach($data as $k=>$v) {
                    ?>
        ...
        <li>
            <b></b>
            <div><img src="/cn/images/masterOf_img03.png" alt="图片"/></div>
            <h4>面试</h4>
            <ul>
                <?php
                $data = \app\modules\cn\models\Content::getContent(['category' => '128,88,136','pageSize' => 5]);
                foreach($data as $k=>$v) {
                    ?>
        ...
        <li>
            ...
            <ul>
                <?php
                $data = \app\modules\cn\models\Content::getContent(['category' => '129,88,136','pageSize' => 5]);
                foreach($data as $k=>$v) {
                    ?>
    ...
    <ul>
        <li>
            ...
            <div>
                ...
                <ul>
                    <?php
                    $data = \app\modules\cn\models\Content::getContent(['category' => '225,89,136','pageSize' => 5]);
                    foreach($data as $k=>$v) {
                        ?>
                        <li><a href="/word-details/<?php echo $v['id']?>/225.html"><?php echo $v['name']?></a></li>
                    <?php
        ...
        <li>
            ...
            <div>
                ...
                <ul>
                    <?php
                    $data = \app\modules\cn\models\Content::getContent(['category' => '127,89,136','pageSize' => 5]);
                    foreach($data as $k=>$v) {
                        ?>
        ...
        <li>
            ...
            <div>
                ...
                <ul>
                    <?php
                    $data = \app\modules\cn\models\Content::getContent(['category' => '128,89,136','pageSize' => 5]);
                    foreach($data as $k=>$v) {
                        ?>
        ...
        <li>
            ...
            <div>
                ...
                <ul>
                    <?php
                    $data = \app\modules\cn\models\Content::getContent(['category' => '129,89,136','pageSize' => 5]);
                    foreach($data as $k=>$v) {
                        ?>
...
<div id="TA" class="masterOfC">
    <ul>
        <li>
            ...
            <ul>
                <?php
                $data = \app\modules\cn\models\Content::getContent(['category' => '225,90,136','pageSize' => 5]);
                foreach($data as $k=>$v) {
                    ?>
                    <li><a href="/word-details/<?php echo $v['id']?>/225.html"><?php echo $v['name']?></a></li>
                <?php
        ...
        <li>
            ...
            <ul>
                <?php
                $data = \app\modules\cn\models\Content::getContent(['category' => '127,90,136','pageSize' => 5]);
                foreach($data as $k=>$v) {
                    ?>
                    <li><a href="/word-details/<?php echo $v['id']?>/89,127.html"><?php echo $v['name']?></a></li>
                <?php
        ...
        <li>
            ...
            <ul>
                <?php
                $data = \app\modules\cn\models\Content::getContent(['category' => '128,90,136','pageSize' => 5]);
                foreach($data as $k=>$v) {
                    ?>
                    <li><a href="/word-details/<?php echo $v['id']?>/89,128.html"><?php echo $v['name']?></a></li>
                <?php
        ...
        <li>
            ...
            <ul>
                <?php
                $data = \app\modules\cn\models\Content::getContent(['category' => '129,90,136','pageSize' => 5]);
                foreach($data as $k=>$v) {
                    ?>
                    <li><a href="/word-details/<?php echo $v['id']?>/89,129.html"><?php echo $v['name']?></a></li>
                <?php
...
<div class="otherSort">
    <ul>
        <li>
            ...
            <ul>
                <?php
                $data = \app\modules\cn\models\Content::getContent(['category' => '225,91,136','pageSize' => 5]);
                foreach($data as $k=>$v) {
                    ?>
                    <li><a href="/word-details/<?php echo $v['id']?>/225.html"><?php echo $v['name']?></a></li>
                <?php
        ...
        <li>
            ...
            <ul>
                <?php
                $data = \app\modules\cn\models\Content::getContent(['category' => '127,91,136','pageSize' => 5]);
                foreach($data as $k=>$v) {
                    ?>
                    <li><a href="/word-details/<?php echo $v['id']?>/89,127.html"><?php echo $v['name']?></a></li>
                <?php
        ...
        <li>
            ...
            <ul>
                <?php
                $data = \app\modules\cn\models\Content::getContent(['category' => '159,91,136','pageSize' => 5]);
                foreach($data as $k=>$v) {
                    ?>
                    <li><a href="/word-details/<?php echo $v['id']?>/89,128.html"><?php echo $v['name']?></a></li>
                <?php
        ...
        <li>
            ...
            <ul>
                <?php
                $data = \app\modules\cn\models\Content::getContent(['category' => '129,91,136','pageSize' => 5]);
                foreach($data as $k=>$v) {
                    ?>
                    <li><a href="/word-details/<?php echo $v['id']?>/89,129.html"><?php echo $v['name']?></a></li>
                <?php
...
<div class="otherCityShow threeStyle">
    <ul>
        <li>
            <b></b>
            <div class="circle">
            ...
            <div class="haveUL">
                <ul>
                    <?php
                    $data = \app\modules\cn\models\Content::getContent(['category' => "136,93","pageSize" => 5]);
                    foreach($data as $v) {
                        ?>
        ...
        <li>
            ...
            <div class="haveUL">
                <ul>
                    <?php
                    $data = \app\modules\cn\models\Content::getContent(['category' => "136,94","pageSize" => 5]);
                    foreach($data as $v) {
                        ?>
        ...
        <li>
            ...
            <div class="haveUL">
                <ul>
                    <?php
                    $data = \app\modules\cn\models\Content::getContent(['category' => "136,95","pageSize" => 5]);
                    foreach($data as $v) {
                        ?>
        ...
        <li>
            ...
            <div class="haveUL">
                <ul>
                    <?php
                    $data = \app\modules\cn\models\Content::getContent(['category' => "136,96","pageSize" => 5]);
                    foreach($data as $v) {
                        ?>
        ...
        <li>
            ...
            <div class="haveUL">
                <ul>
                    <?php
                    $data = \app\modules\cn\models\Content::getContent(['category' => "136,97","pageSize" => 5]);
                    foreach($data as $v) {
                        ?>
