    ...
    <link rel="stylesheet" href="/cn/css/<?php echo $id==110?'IndividualServices':'mba-phd'?>.css"/>
...
<div class="abroadProBig">
    <?php
        if($id == 110) {
            ...
            <div class="abroadPro-top">
                <img src="/cn/images/Individual_title.png" alt="图标"/>
            </div>
            <div class="abroadPro-group">
                <ul>
                    <li>
                        <div class="inputBG redsFont inputBG01">
                    ...
                    <li>
                        <div class="inputBG redsFont inputBG02">
                            <a href="#">申友留学服务四大优势</a>
    ...
    if($id == 111) {
        ?>
        <div class="abroadPro-top">
            <img src="/cn/images/mba_title.png" alt="图标"/>
        </div>
        <div class="abroadPro-group">
            <ul>
                <li>
                    <div class="inputBG redFont inputBG01">
                        <a href="#">留学评估</a>
                        <div>
                            <span></span>
                            <img src="/cn/images/mba_peron01.png" alt="里面的图片"/>
                ...
                <li>
                    <div class="inputBG redFont inputBG02">
                        <a href="#">申友留学服务四大优势</a>
                        <div>
                            <span></span>
                            <img src="/cn/images/mba_peron03.png" alt="里面的图片"/>
    ...
    <div class="customization">
        <div class="cust-top">
            <div>
                <img src="/cn/images/mba_titleFont01.png" alt="文字图片"/>
            </div>
        </div>
    ...
    <div class="abroadPro-advan advanBG05">
