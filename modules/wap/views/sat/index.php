...
<meta name="keywords" content="SAT报名,SAT考试时间,SAT备考,SAT换库,SAT机经,SAT逻辑,SAT真题,SAT培训,SAT课程,SAT网络课程,SAT辅导,SAT班,SAT阅读,SAT数学,SAT语法">
<meta name="description" content="申友致力培育SAT高分学员.为学员提供SAT报名、SAT模考、SAT培训、SAT备考等服务,被业界称为SAT高分基地.">
<meta name="title" content="SAT官网_SAT考试_SAT培训-申友SAT">
...
<title>SAT官网_SAT考试_SAT培训-申友SAT</title>
</head>
<body>
<!--内页头部-->
<header class=" pd-0 bg-1">
  <div class="header-2">
    ...
    <span class=" tb header-tit tm">SAT课程</span>
...
<!--内页头部 END-->
<!--广告位-->
<div class="mg-t1"><a href="#"><img src="/wap/images/ad-11.png" alt=""></a></div>
<!--广告位 END-->
<!--栏目-->
