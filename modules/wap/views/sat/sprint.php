...
<header class=" pd-0 bg-1">
  <div class="header-2">
    ...
    <span class=" tb header-tit tm">SAT冲刺小班</span>
...
<div class="bg-1 pd-0 mg-t1 clearfix">
  <div class="sat-people tl">
    ...
    <p class="open-time">1.  托福100分以上，学前新SAT考试成绩在1200分左右的学员。</p>
    <p class="open-time">2.  参加过SAT全能强化班，希望考前进行集训，冲刺高分的学员。</p>
  </div>
  <img class="suit-img" src="/wap/images/toefl.png" alt="">
</div>
<div class="pd-0 bg-1 mg-t1">
  <img src="/wap/images/sat-sprint.png" alt="">
</div>
<!--footer-->
