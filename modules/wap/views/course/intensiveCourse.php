...
<head>
    <?php
    $seo = \app\modules\cn\models\Category::getSeoInfo(163);
    ?>
...
<!-----------------------------导航end------------------------------>
<div class="courseTop">
    <img src="/cn/images/course-fontImg01.png" alt="头部图"/>
</div>

<div class="intesiveC">
    <ul>
        <?php
        $data = \app\modules\cn\models\Content::getContent(['category' => '163','pageSize' => 8]);
        foreach($data as $v) {
            ?>
            <li>
                <img src="<?php echo $v['image']?>" alt="图片">
                <h4><a href="/picture-details/<?php echo $v['id']?>/163.html"><?php echo $v['name']?></a></h4>
            </li>
        <?php
        }
        ?>
