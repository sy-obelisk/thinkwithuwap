...
<header class=" pd-0 bg-1">
    <div class="header-2">
        ...
        <span class=" tb header-tit tm">GMAT周末班</span>
...
<div style="margin-bottom: 0.8rem">
    <img src="/wap/images/g-6.png" alt="">
</div>
<div>
    <div class="tm pd-1"><img src="/wap/images/g-7.png" alt=""></div>
    <ul class="books-list">
        <li>
            <img class="book-img" src="/wap/images/g-8.png" alt="">
            <p class="books-name">《申友第五代GMAT讲义》</p>
        </li>
        <li>
            <img class="book-img" src="/wap/images/g-9.png" alt="">
            <p class="books-name">《申友GMAT语法解析》</p>
        </li>
        <li>
            <img class="book-img" src="/wap/images/g-10.png" alt="">
            <p class="books-name">《申友GMAT阅读紫皮书》</p>
        </li>
    </ul>
</div>
<!--footer-->
