...
<header class="pd-0 details-top bc-175">
    <div class="header-2">
        ...
        <span class="tb header-tit tm">GMAT每日一题</span>
...
<div class="success-text">
    ...
    <div class="text-next clearfix">
        <?php if(count($next)>0) { ?>
            <a href="/GMAT/details/<?php echo $next[0]['id']?>.html">下一篇：<span><?php echo $next[0]['name']?></span></a>
        <?php
        }
        ?>
        <?php if(count($prev)>0) { ?>
            <a href="/GMAT/details/<?php echo $prev[0]['id']?>.html">上一篇：<span><?php echo $prev[0]['name']?></span></a>
        <?php
        }
        ?>
    </div>
    ...
    <ul>
        <?php
            foreach($correlation as $v) {
                ?>
                <li class="border"><a href="/GMAT/details/<?php echo $v['id']?>.html"><?php echo $v['name']?></a></li>
            <?php
            }
        ?>
    </ul>
