...
<div class="span10" id="datacontent">
    <ul class="breadcrumb">
        ...
        <li class="active">留学评估</li>
    </ul>
    <ul class="nav nav-tabs">
        <li class="active">
            <a href="javascript:;" onclick="javascript:openall();">留学评估(<?php echo count($data)?>)</a>
        </li>
    </ul>
    <legend>用户</legend>
                    ...
                    <td>
                        <div>
                            ...
                            foreach($block as $val) {
                                ?>
                                <a class="btn"
                                   href="<?php echo baseUrl?>/thinku/study-plan/<?php echo $val['value']?>?id=<?php echo $v['id']?>"><?php echo $val['name']?></a>
                            <?php
                            }
                            ?>
                        </div>
