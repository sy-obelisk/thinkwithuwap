...
<div class="span10" id="datacontent">
    <ul class="breadcrumb">
        ...
        <li class="active">在线测评</li>
    </ul>
    <ul class="nav nav-tabs">
        <li class="active">
            <a href="javascript:;" onclick="javascript:openall();">在线测评(<?php echo count($data)?>)</a>
        </li>
    </ul>
    <legend>用户</legend>
        ...
        <table class="table table-hover">
            ...
            foreach($data as $v) {
                ...
                <tr>
                    ...
                    <td><span><?php echo $v['class']?></span></td>
                    ...
                    <td>
                        <div>
                            ...
                            foreach($block as $val) {
                                ?>
                                <a class="btn"
                                   href="<?php echo baseUrl?>/thinku/online-assessment/<?php echo $val['value']?>?id=<?php echo $v['id']?>"><?php echo $val['name']?></a>
                            <?php
                            }
                            ?>
                        </div>
