 ...
 */
	...
	class AppControl extends Controller {
        ...
        public function limitBlock(){
            ...
            $this->block = Yii::$app->db->createCommand("select b.* from {{%user_block}} ub LEFT JOIN {{%block}} b ON ub.blockId = b.id WHERE ub.userId = $userId AND b.pid=$controller->id")->queryAll();
            return $sign;
        }
	}
?>