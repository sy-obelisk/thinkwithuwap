define("raphael", [], function () {
    var a;
    return function (b) {
        var c, d, e = "0.4.2", f = "hasOwnProperty", g = /[\.\/]/, h = "*", i = function () {
        }, j = function (a, b) {
            return a - b
        }, k = {n: {}}, l = function (a, b) {
            a = String(a);
            var e, f = d, g = Array.prototype.slice.call(arguments, 2), h = l.listeners(a), i = 0, k = [], m = {}, n = [], o = c;
            c = a, d = 0;
            for (var p = 0, q = h.length; q > p; p++)"zIndex"in h[p] && (k.push(h[p].zIndex), h[p].zIndex < 0 && (m[h[p].zIndex] = h[p]));
            for (k.sort(j); k[i] < 0;)if (e = m[k[i++]], n.push(e.apply(b, g)), d)return d = f, n;
            for (p = 0; q > p; p++)if (e = h[p], "zIndex"in e)if (e.zIndex == k[i]) {
                if (n.push(e.apply(b, g)), d)break;
                do if (i++, e = m[k[i]], e && n.push(e.apply(b, g)), d)break; while (e)
            } else m[e.zIndex] = e; else if (n.push(e.apply(b, g)), d)break;
        ...
        }, "undefined" != typeof module && module.exports ? module.exports = l : "undefined" != typeof a ? a("eve", [], function () {
            return l
        }) : b.eve = l
    }(this), function (b, c) {
        "function" == typeof a && a.amd ? a(["eve"], function (a) {
            return c(b, a)
        }) : c(b, b.eve)
    }(this, function (a, b) {
        function c(a) {
        ...
        function m(a, b, d) {
            ...
            for (q = 0; i > q; q++)for (var s = 0; k > s; s++) {
                ...
                if (z) {
                    ...
                    A >= 0 && 1 >= A && B >= 0 && 1 >= B && (d ? p++ : p.push({x: z.x, y: z.y, t1: A, t2: B}))
                }
            }
            return p
        }
        ...
        var Bb = c.pathBBox = function (a) {
            ...
            for (var d = Eb(a), e = b && Eb(b), f = {
                ...
                qx: null,
                qy: null
            }, g = {x: 0, y: 0, bx: 0, by: 0, X: 0, Y: 0, qx: null, qy: null}, h = (function (a, b, c) {
                var d, e;
                ...
                var q = function (d, e) {
                    ...
                    if (!s) {
                        ...
                        if (k = k.replace(/[\(\)\s,\xb0#]/g, "_"), a.gradient && k != a.gradient.id && (p.defs.removeChild(a.gradient), delete a.gradient), !a.gradient) {
                            s = q(j + "Gradient", {id: k}), a.gradient = s, q(s, "radial" == j ? {
                                fx: m,
                                fy: n
                            } : {
                                x1: u[0],
